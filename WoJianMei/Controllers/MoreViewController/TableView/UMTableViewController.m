...
#define UMENG_APP_KEY @"51b942ae56240bd8cb009671"
...
- (void)setupTableView
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain appkey:UMENG_APP_KEY slotId:nil currentViewController:self];
