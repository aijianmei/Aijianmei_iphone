...
//        [toolBar setBackgroundImage:[[UIImage imageNamed:@"keyBoardBack"] resizableImageWithCapInsets:insets] forToolbarPosition:0 barMetrics:0];
        ...
        [toolBar setBackgroundImage:[[UIImage imageNamed:@"topmenu_bg.png"] resizableImageWithCapInsets:insets] forToolbarPosition:0 barMetrics:0];
        ...
        //可以自适应高度的文本输入框
        textView = [[UIExpandingTextView alloc] initWithFrame:CGRectMake(50, 5, 250, 36)];
...
//        voiceButton.frame = CGRectMake(5,toolBar.bounds.size.height-38.0f,buttonWh,buttonWh);
        ...
        [voiceButton setImage:[UIImage imageNamed:@"top_bar_backButton.png"] forState:UIControlStateNormal];
        ...
        voiceButton.frame = CGRectMake(5,toolBar.bounds.size.height-35.0f,48,29);
...
//        faceButton.frame = CGRectMake(toolBar.bounds.size.width - 85.0f,toolBar.bounds.size.height-38.0f,buttonWh,buttonWh);
...
//        
//        [sendButton setBackgroundImage:[UIImage imageNamed:@"top_bar_commonButton.png"] forState:UIControlStateNormal];
//        
//        [sendButton addTarget:self action:@selector(sendAction) forControlEvents:UIControlEventTouchUpInside];
////        sendButton.frame = CGRectMake(toolBar.bounds.size.width - 20.0f,toolBar.bounds.size.height-38.0f,buttonWh+4,buttonWh);
//        
//        sendButton.frame = CGRectMake(toolBar.bounds.size.width - 50.0f,toolBar.bounds.size.height-38.0f,48,29);
...
-(void)expandingTextViewDidChange:(UIExpandingTextView *)expandingTextView
{
    ...
    if ([expandingTextView.text length] > 0){
        ...
        [sendButton.titleLabel setTextColor:[UIColor whiteColor]];
...
-(void)voiceChange{
    ...
    if ([delegate respondsToSelector:@selector(clickBackButton:)])
    {
        [delegate clickBackButton:nil];
    }
}
