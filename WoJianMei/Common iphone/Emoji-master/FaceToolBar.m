...
-(id)initWithFrame:(CGRect)frame superView:(UIView *)superView{
    ...
    if (self) {
        ...
        UIEdgeInsets insets = UIEdgeInsetsMake(57, 0, 40, 0);
...
//        [toolBar setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"topmenu_bg.png"]]];
        
        
       
        //可以自适应高度的文本输入框
        textView = [[UIExpandingTextView alloc] initWithFrame:CGRectMake(55, 5, 210, 36)];
        ...
        [voiceButton setBackgroundImage:[UIImage imageNamed:@"top_bar_backButton.png"] forState:UIControlStateNormal];
        [voiceButton setTitle:@"返回" forState:UIControlStateNormal];
        [voiceButton.titleLabel setFont:font];
...
//        voiceButton.frame = CGRectMake(5,toolBar.bounds.size.height-38.0f,buttonWh,buttonWh);
          voiceButton.frame = CGRectMake(5,toolBar.bounds.size.height-38.0f,48,29);
...
//        [toolBar addSubview:faceButton];
       ...
       [sendButton setBackgroundImage:[UIImage imageNamed:@"top_bar_commonButton"] forState:UIControlStateNormal];
        [sendButton.titleLabel setFont:font];
...
//        sendButton.frame = CGRectMake(toolBar.bounds.size.width - 40.0f,toolBar.bounds.size.height-38.0f,buttonWh+4,buttonWh);
          ...
          sendButton.frame = CGRectMake(toolBar.bounds.size.width - 40.0f - 14,toolBar.bounds.size.height-38.0f,48,30);
