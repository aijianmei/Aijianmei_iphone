...
-(void)initSupplementViewController{
    ...
    self.homeViewController.title = @"营养";
...
-(void)initNutriViewController{
    ...
    self.nutriViewController.title = @"补充";
    }
...
-(void)initWorkOutManagerViewController{
    ...
    self.workOutManagerViewController =[[WorkOutManagerViewController alloc] initWithNibName:@"WorkoutViewController" bundle:nil];
...
//                       [self initWorkOutViewController];
                        ...
                        WorkoutViewController *homeVC = [[WorkoutViewController alloc]initWithNibName:@"WorkoutViewController" bundle:nil];
                        homeVC.title = @"首页";
                        _navigationController = [[UINavigationController alloc] initWithRootViewController:homeVC] ;
                        [homeVC release];
                        self.viewDeckController.centerController = _navigationController;
