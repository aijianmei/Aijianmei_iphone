...
- (void)_setup
{
    ...
    _reminderLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 450, 200, 60)];
    [_reminderLabel setTag:123];
    [_reminderLabel setBackgroundColor:[UIColor greenColor]];
    ...
    flipFrame.origin = CGPointMake(10.0f, CGRectGetHeight(self.view.bounds) - 30.0f);
...
-(void)_handleCancleButton:(UIButton *)button{
...
{
    [_strobeView stop];
    [_reminderLabel setText:@"点击屏幕可以继续拍摄！"];
}

- (void)visionDidResumeVideoCapture:(PBJVision *)vision
{
    [_strobeView start];
    [_reminderLabel setText:@"松开手可以停止拍摄！"];
}
...
- (void)vision:(PBJVision *)vision capturedVideo:(NSDictionary *)videoDict error:(NSError *)error
{
    ...
    VideoManager * videoManager = [VideoManager defaultManager];
    [videoManager setVideoPath:videoPath];
